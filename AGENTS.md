...
| `fix/publicar-entrenos-sin-clave` | Retira la clave visible, mantiene “Publicar para coaches” visible y conserva de forma invisible la autorización previa del dispositivo hasta que existan cuentas individuales | PR #37. Local: 543 tests y build en verde. Marian autorizó fusionar y publicar en Production el 8 de septiembre |
