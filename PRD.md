...
2. **Registros operativos o de cliente:** primera clase, incidencia, seguimiento o relevo se gestionan dentro de `Mi turno`, sin utilizar el término feedback para estas acciones.
