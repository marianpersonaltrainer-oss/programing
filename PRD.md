...
El nuevo trabajo no sustituye ni redefine Programming EVO. Añade, si el piloto lo valida, una superficie de lectura y ejecución llamada **Equipo EVO · Incorporaciones**.

**Regla de separación:** Programming puede mostrar al entrenador lo que necesita ver, pero no será el propietario definitivo del expediente operativo, tareas, evidencias o historial del cliente.
...
## 12. Alcance de la primera versión construible

Solo si el piloto operativo valida la necesidad:
...
- PRD creado.
- PLAN creado.
- AGENTS pendiente de crear en esta rama.
- Código sin modificar.
- Fase 1 todavía no iniciada.
- Primer trabajo autorizado propuesto: esqueleto visual local.
