...
const RECORD_LABELS = {
  apertura: 'Apertura',
  revision: 'Personas y novedades revisadas',
  cierre: 'Finalizar turno',
}
const RESULT_LABELS = { completado: 'Completado', incidencia: 'Incidencia' }

export default function ShiftProtocolLogList({
  logs,
  loading = false,
  showCoach = false,
  showShift = false,
