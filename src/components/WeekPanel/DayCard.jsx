...
export default function DayCard({ day, session, isActive, onClick, onRemove }) {
  ...
  return (
    <div
      ...
      `}
      style={{
        borderLeft: isConfirmed ? `4px solid ${accentColor}` : `4px solid ${evoBrand.border}`,
      }}
    >
      <div className="p-4">
        ...
        {isEmpty ? (
          ...
          <div className="space-y-2">
                ...
                return (
                  <span
                    ...
                    style={{
                      ...
                      color: color?.text || color?.bg || evoBrand.text,
            ...
            <p className={`text-[11px] ${coachText.muted} line-clamp-2 leading-relaxed font-medium`}>
